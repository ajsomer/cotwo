...
export const organisations = pgTable("organisations", {
	...
	tyroProviderNumber: text("tyro_provider_number"),
	tyroApiKeyEncrypted: text("tyro_api_key_encrypted"),
	tyroBusinessId: text("tyro_business_id"),
...
export const payments = pgTable("payments", {
	...
	paymentRequestUrl: text("payment_request_url"),
